...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <%--<div id="control-label" style="float: right">
            <asp:Label runat="server" ID="labelUsuarioLogueado" Text ="HIKA" Font-Bold="True" CssClass="col-sm-5  control-label"></asp:Label>
        </div>--%>
