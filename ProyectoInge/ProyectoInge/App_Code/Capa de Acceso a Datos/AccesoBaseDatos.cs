...
namespace ProyectoInge.App_Code.Capa_de_Acceso_a_Datos
{
    public class AccesoBaseDatos
    {
       ...
       String conexion = @"Data Source=eccibdisw; Initial Catalog=g3inge; Integrated Security=SSPI";        //String conexion = @"Data Source=ASUS; Initial Catalog=g3inge; Integrated Security=SSPI";
